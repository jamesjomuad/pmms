...
use Database\Factories\ShopDrawingFactory;
...
{
    /** @use HasFactory<ShopDrawingFactory> */
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['title', 'description', 'drawing_number', 'revision_number', 'status', 'due_date', 'submitted_at', 'approved_at', 'rejection_reason'])
            ->logOnlyDirty()
            ->dontLogEmptyChanges();
    }
    ...
    /**
     * Get the project that owns the shop drawing.
     *
    ...
    /**
     * Get the user assigned to the shop drawing.
     *
    ...
    /**
     * Scope to shop drawings for a specific project.
     *
     * @param  Builder<ShopDrawing>  $query
     * @return Builder<ShopDrawing>
     */
