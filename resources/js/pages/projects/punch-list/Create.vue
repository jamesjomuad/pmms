...
const submit = () => {
    form.post(`/projects/${props.project.id}/punch-list`);
};
...
<template>
    <Head :title="`Add Punch List Item - ${project.name}`" />

    <h1 class="sr-only">Add Punch List Item</h1>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                :class="{ 'border-destructive': form.errors.trade }"
                            />
                            <p v-if="form.errors.trade" class="text-sm text-destructive">
                                {{ form.errors.trade }}
                            </p>
                        </div>
                    </div>
