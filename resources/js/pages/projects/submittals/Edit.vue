...
const form = useForm({
    ...
    spec_section: props.submittal.spec_section ?? '',
    assigned_to: props.submittal.assigned_to,
    due_date: props.submittal.due_date ?? '',
});
...
<template>
    <Head :title="`Edit ${submittal.title} - Submittal`" />

    <h1 class="sr-only">Edit Submittal</h1>
