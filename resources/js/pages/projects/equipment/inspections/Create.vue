...
const form = useForm({
    inspected_by: null as number | null,
    inspected_date: '',
    result: 'passed',
    notes: '',
});
...
const submit = () => {
    form.post(
        `/projects/${props.project.id}/equipment/${props.equipment.id}/inspections`,
    );
};
...
<template>
    <Head :title="`Add Inspection - ${equipment.title}`" />

    <h1 class="sr-only">Add Equipment Inspection</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            />
                            <p
                                v-if="form.errors.inspected_date"
                                class="text-sm text-destructive"
                            >
                                {{ form.errors.inspected_date }}
                            </p>
