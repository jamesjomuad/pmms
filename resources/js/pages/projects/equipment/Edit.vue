...
const form = useForm({
    title: props.equipment.title,
    description: props.equipment.description ?? '',
    manufacturer: props.equipment.manufacturer ?? '',
    model_number: props.equipment.model_number ?? '',
    serial_number: props.equipment.serial_number ?? '',
    cost: props.equipment.cost ?? '',
    quantity: props.equipment.quantity,
    assigned_to: props.equipment.assigned_to,
    lead_time: props.equipment.lead_time ?? '',
    expected_delivery: props.equipment.expected_delivery ?? '',
});

const submit = () => {
    form.patch(`/projects/${props.project.id}/equipment/${props.equipment.id}`);
};
...
<template>
    <Head :title="`Edit ${equipment.title} - Equipment`" />
